                ...
                <main className="max-w-2xl mx-auto p-4 mt-8">
                    <Card className="p-6 text-center">
                        ...
                        <p className="text-[#99784D] mb-4">
                            Your account is currently pending approval from your
                            Troop's Scoutmaster. You'll receive an email
                            notification once your account has been approved.
                        </p>

                        <div className="bg-[#fff9f0] border border-[#ec8e13] rounded-lg p-4 text-left">
                            <h2 className="font-semibold text-[#ec8e13] mb-2">
                                What happens next?
                            </h2>
                            <ul className="text-[#99784D] text-sm space-y-2">
                                <li>
                                    • Your Scoutmaster will review your
                                    registration
                                </li>
                                <li>
                                ...
                                <li>
                                    • You can then sign in and access all Troop
                                    Talk features
                                </li>
                            </ul>
                        </div>
